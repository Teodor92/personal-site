...
- **CV as data**: `src/data/cv.ts` holds roles/education/skills/volunteering, rendered by `src/pages/cv.astro`. Roles flagged `highlight: true` also appear on the homepage. Edit the data, not the markup.

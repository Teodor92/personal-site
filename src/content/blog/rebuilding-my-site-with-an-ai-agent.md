...
And it kept going after that. The following days added view transitions, a ⌘K command palette, generated social cards, tag pages, an accessibility pass, and a print-friendly CV — each one a "hey, could we…" that turned into a shipped feature within the hour.

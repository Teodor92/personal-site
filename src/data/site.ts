export const site = {
  name: 'Teodor Kurtev',
  role: 'Senior Applied AI Software Engineer at YuLife',
  pitch:
  ...
  description:
    'Personal site and blog of Teodor Kurtev, Senior Applied AI Software Engineer, writing about AI-assisted engineering, tooling and teams.',
